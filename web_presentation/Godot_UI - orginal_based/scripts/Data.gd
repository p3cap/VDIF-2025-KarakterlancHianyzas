...
var default_data = {
	...
	"currency_M": 1000,
	"buildings": {
		0: Building.new("Petőfi Sándor utca 12", 60, 5000, 1, 98, "oktatás", ["oktatás"], 0),
		1: Building.new("Kossuth Lajos tér 5", 60, 2680, 1, 98, "oktatás", ["oktatás"], 0),
		2: Building.new("Rákóczi út 87", 60, 400, 1, 98, "lakóház", [], 0),
		3: Building.new("Szabadság utca 34", 60, 600, 1, 98, "lakóház", [], 0),
		4: Building.new("Arany János köz 9", 60, 600, 1, 98, "rendőrség", ["rendőrség"], 0),
		5: Building.new("Táncsics Mihály utca 56", 60, 200, 1, 98, "lakóház", [], 0),
		6: Building.new("Ady Endre út 23", 60, 3000, 1, 98, "munka", ["munkahely"], 0),
		7: Building.new("Deák Ferenc tér 3", 60, 2500, 1, 98, "kórház", ["egészségügy"], 0),
		8: Building.new("Bartók Béla út 78", 60, 600, 1, 98, "lakóház", [], 0),
		9: Building.new("Jókai Mór utca 11", 60, 800, 1, 98, "lakóház", [], 0),
		10: Building.new("Bajcsy-Zsilinszky út 45", 60, 600, 1, 98, "lakóház", [], 0),
		11: Building.new("Dózsa György utca 19", 60, 2100, 1, 98, "oktatás", ["oktatás"], 0),
		12: Building.new("Hunyadi János tér 7", 60, 300, 1, 98, "lakóház", [], 0),
		13: Building.new("Bem József utca 30", 60, 200, 1, 98, "bolt", ["bolt"], 0),
		14: Building.new("Vörösmarty Mihály út 62", 60, 100, 1, 98, "bolt", ["bolt"], 0),
	},
	"citizens": 0,
	"projects": {},
	"complaints": [],
