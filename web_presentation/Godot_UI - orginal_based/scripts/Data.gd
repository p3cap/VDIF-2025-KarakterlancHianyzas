...
var default_data = {
	...
	"currency_M": 100000,
	"buildings": {
		0: Building.new("Petőfi Sándor utca 12", 60, 150, 1, 98, "lakóház", [], 200),
		1: Building.new("Kossuth Lajos tér 5", 60, 150, 1, 98, "lakóház", [], 200),
		2: Building.new("Rákóczi út 87", 60, 150, 1, 98, "lakóház", [], 200),
		3: Building.new("Szabadság utca 34", 60, 150, 1, 98, "lakóház", [], 200),
		4: Building.new("Arany János köz 9", 60, 150, 1, 98, "lakóház", [], 200),
		5: Building.new("Táncsics Mihály utca 56", 60, 150, 1, 98, "lakóház", [], 200),
		6: Building.new("Ady Endre út 23", 60, 150, 1, 98, "lakóház", [], 200),
		7: Building.new("Deák Ferenc tér 3", 60, 150, 1, 98, "lakóház", [], 200),
		8: Building.new("Bartók Béla út 78", 60, 150, 1, 98, "lakóház", [], 200),
		9: Building.new("Jókai Mór utca 11", 60, 150, 1, 98, "lakóház", [], 200),
		10: Building.new("Bajcsy-Zsilinszky út 45", 60, 150, 1, 98, "lakóház", [], 200),
		11: Building.new("Dózsa György utca 19", 60, 150, 1, 98, "lakóház", [], 200),
		12: Building.new("Hunyadi János tér 7", 60, 150, 1, 98, "lakóház", [], 200),
